...
class CarRacing:
    ...
    def highscore(self, count):
        ...
        self.gameDisplay.blit(text, (10, 20))

    def display_credit(self):
        font = pygame.font.SysFont("lucidaconsole", 14)
        text = font.render("Press 'SPACE' To Play Again", True, self.white)
        self.gameDisplay.blit(text, (315, 420))
        text = font.render("Or Game Will Restart in 2 Seconds", True, self.white)
        self.gameDisplay.blit(text, (295, 440))
